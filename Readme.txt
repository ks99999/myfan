...
Реализовано управление прямо из интерфейса HiveOS. Есть так же цифровой темепературный датчик.
...
ШИМ модуляция будет на D3 его надо соединить со входом PWM кулера. Если кулеров несколько, то необходим еще фанхаб.
Если кулер запитывается от отдельного блока питания, то необходимо соединить минусы всех источников тока!
Работа проверялась на клоне ардуино с чипом CH340 и совместимой платой LGT8F328P

Программная часть.
выполнить на риге команду curl https://raw.githubusercontent.com/ks99999/myfan/main/myfan-setup.sh | bash
